...
public class ReplyMessage
{
    ...
    public const string MESSAGE_QUERY_EMTY = "No se encontro registros.";
    ...
    public const string MESSAGE_ACTIVTE = "El registro ha sido activado.";
    public const string MESSAGE_TOKEN = "Token generado correcamente.";
    public const string MESSAGE_VALIDATE = "Errores de validacion.";
    public const string MESSAGE_FAILED = "Opereacion fallida.";
}
