...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.UserRoleConfiguration;

public class UserRoleConfiguration : IEntityTypeConfiguration<UserRole>
{
  public void Configure(EntityTypeBuilder<UserRole> builder)
  {
   builder.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A35CB25F9A4");
