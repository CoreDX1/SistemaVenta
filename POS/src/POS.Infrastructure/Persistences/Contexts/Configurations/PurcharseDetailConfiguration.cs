...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.PurcharseDetailConfiguration;
...
public class PurcharseDetailConfiguration : IEntityTypeConfiguration<PurcharseDetail>
{
  ...
  {
 builder.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248BFF8F3A84");
