...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.MenuRoleConfiguration;
...
public class MenuRoleConfiguration : IEntityTypeConfiguration<MenuRole>
{
    ...
    {
        builder.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0CBCE9D971");
