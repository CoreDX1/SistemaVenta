...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.ProductConfiguration;

public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        builder.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CDC8C288AF");
