...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.PurcharseConfiguration;
...
public class PurcharseConfiguration : IEntityTypeConfiguration<Purcharse>
{
  ...
  {
builder.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674B25AFC137");
