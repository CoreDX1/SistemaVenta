...
namespace POS.Infrastructure.Persistences.Contexts.Configuration.UsersBranchOfficeConfiguration;
...
public class UsersBranchOfficeConfiguration : IEntityTypeConfiguration<UsersBranchOffice>
{
  ...
  {
  builder.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A22997BF4");
